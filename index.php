...
<div class="navbar navbar-inverse navbar-fixed-top visible-phone noprint" id="phone-navbar">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href="#">Sumit Kumar</a>
      ...
      <div class="row" id="content">
        ...
        <div class="span9 equal" id="main-content">
        	...
        	<div class="section first-section" id="about-me">
	            <div class="row author">
	            	<div class="span3">
	            		...
	            		<img class="img-rounded" src="logo.jpg" alt="">
	            	</div>
	            	<div class="span6">
            ...
            <div class="section" id="personal-information">
	            <h2 class="section-title"><span class="glyphicons user"><i></i></span>Personal Information
                    <a href="#phone-navbar" class="top visible-phone"><span class="glyphicons white up_arrow"><i></i></span></a>
                </h2>
				
				<div class="row">
	        		<div class="infoline span9 first"><div class="row">
	            		<div class="span2 muted">Date of birth</div>
	            		<div class="span7">January 15th, 1985</div>
				  	</div></div>
	        		...
	        		<div class="infoline span9"><div class="row">
				  		...
				  		<div class="span7">sumitk.85@gmail.com</div>
				  	</div></div>
				  	<span class="clear"></span>
	        		...
	        		<div class="infoline span9 last"><div class="row">
					  	...
					  	<div class="span7"><a href="http://www.sumitk.in" title="">www.sumitk.in</a></div>
					</div></div>
				  	<span class="clear"></span>
		  	...
		  	<div class="section" id="employment">
			  	<h2 class="section-title"><span class="glyphicons share_alt"><i></i></span>Employment
					 ...
					 <div class="timeline-item">
		  			 	...
		  			 	<div class="timeline-item-content">
							...
							<div class="collapse" id="position2">
								...
								I learned PHPUnit to write the unit tests for the existing PHP code and WebInject for running integration tests for web services. 
								I automated the unit tests and integration tests through Jenkins. I also used Jenkins to create nightly builds for deployment.
								I also researched on new technologies like VoltDB that can be helpful for Pinger's growth.</p>	
							</div>
						</div>
					 </div><!--/timeline-item--> 
					 <span class="clear"></span>
					 ...
					 <div class="timeline-item">
		  			 	...
		  			 	<div class="timeline-item-content">
							...
							<div class="collapse" id="position3">
								...
								Customized core product CRAMER/ASMS for telecommunication giant Rogers Canada.
								Applied working knowledge of Spring, EJB & PL/SQL to integrate Amdocs OMS-ASMS-APS.
								Employed interactive and strong communication skills to guide client into ideal software solution for the product CRAMER & ASMS. 
								</p>
							</div>
						</div>
					 </div><!--/timeline-item-->
					 ...
					 <div class="timeline-item">
		  			 	...
		  			 	<div class="timeline-item-content">
							...
							<div class="collapse" id="position4">
								...
								Developed telephony driver & phone firmware for Avaya IP phones.
								Enhanced & solved all the bugs for Avaya one-X Deskphone USB Companion Application.
								Received “BUG BUSTER” award for solving maximum no of bugs
								</p>	
							</div>
						</div>
					 </div><!--/timeline-item--> 
		...
		<div class="section noprint" id="blog">
			<h2 class="section-title">
                <span class="glyphicons pencil"><i></i></span>Bloggggggg
                <a href="#phone-navbar" class="top visible-phone">
                    <span class="glyphicons white up_arrow"><i></i></span>
                </a>
            </h2>
				...
				<div class="span3 blogitem">
					...
					<div class="blogitem-hoverinfo">
						...
						<div class="blogitem-actions">
							<a href="./images/blog01.jpg" class="tips img-circle lightbox" title="Preview image" data-placement="bottom" data-fancybox-group="blogimages">
                                <span class="glyphicons white zoom_in"><i></i></span>
                            </a>
							<a href="#blogitem-1" class="tips more-info img-circle" title="View Post" data-placement="bottom">
                                <span class="glyphicons white share"><i></i></span>
                            </a>
						</div>
					</div>
				</div>
				...
				<div class="span3 blogitem">
					...
					<div class="blogitem-hoverinfo">
						...
						<div class="blogitem-actions">
							...
							<a href="#blogitem-2" class="tips more-info img-circle" title="View Post" data-placement="bottom">
                                <span class="glyphicons white share"><i></i></span></a>
						</div>
					</div>
				</div>
